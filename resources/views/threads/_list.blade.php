    ...
    <div class="uk-child-width-expand" uk-grid>
        <div class="uk-child-width-expand" uk-grid>
            <div class="uk-width-5-6">
                <h4 class="uk-heading-bullet uk-text-bold uk-margin-remove-bottom">
                ...
                <h5 class="uk-margin-remove-top">Posted By: <a href="{{ route('profile', $thread->creator) }}">{{$thread->creator->name}}</a></h5>
            </div>
            <div>
